                                            ...
                                            @foreach ($jobs as $job)
                                                <tr class="active">
                                                    <td>
                                                        ...
                                                        <div class="info1" title="location">{{ $job->jobType->name }} |
                                                            {{ $job->location }}
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div
                                                            class="job-status text-uppercase text-white {{ $job->status == 1 ? 'badge bg-success' : 'badge bg-danger' }}">
                                                            {{ $job->status == 1 ? 'Active' : 'Block' }}</div>
                                                    </td>
                                                    <td>
                                                        <div class="action-dots float-end">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('job.details', $job->id) }}"> <i
